  ...
  const experiences = [
    {
      ...
      work: [
        "Lead structural analysis for commercial and infrastructure projects using SAP2000 and ETABS",
        "Built Python automation tools that cut repetitive calculation workflows by 40%",
        "Drive seismic retrofit designs for public buildings across multidisciplinary teams",
        "Mentor junior engineers on structural modeling and code compliance",
      ],
    },
    {
      ...
      location: "Sacramento, CA",
      work: [
        "Structural calculations for steel, concrete, and wood-frame buildings",
        "Created automated tools for foundation and beam design checks",
        "Contributed to design of a 120,000 sq ft mixed-use development",
        "Conducted site inspections and authored technical client reports",
      ],
    },
    {
      role: "Engineering Intern",
      org: "Caltrans — District 3",
      period: "Summer 2020",
      location: "Marysville, CA",
      work: [
        "Bridge inspection documentation and load rating analysis",
        "Drafted structural detail modifications in AutoCAD and MicroStation",
        "Field inspections of highway bridge structures across Northern California",
      ],
    },
  ];
